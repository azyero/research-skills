...
**通用兼容** —— 支持 Hermes、Claude Code、Cursor、Codex、Windsurf 等主流 AI Agent，换工具不用换 skills。

**学科覆盖广** —— 10 个方向：通用、计算机科学、生物医学、社会科学、经济金融、材料化学、环境科学、人文学科、法学、教育心理学。

**中英双语** —— 每个 skill 都有中英文版本，适应不同语言环境。

**结构化输出** —— 统一的输出模板，生成内容可直接用于开题报告、论文、实验方案。

**质量控制** —— 全局规则约束：不编造文献、标注不确定性、区分事实与推断、主动指出研究设计漏洞。

**一键安装** —— 把仓库地址发给 Agent 即可自动安装，无需手动配置。
